  ...
  describe("create resource", function() {
    before(function() {
      for (var i=0; i<4; i++) {
        ...
        .post('/events/subscription', {"subscription":{"resourceId":"sis-985aae92","protocol":"aws-sns","endpoint":"arn:aws:sns:us-east-1:546276914724:spotinst-test","eventType":"AWS_EC2_INSTANCE_TERMINATE"}})
